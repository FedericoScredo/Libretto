...
public class Esame {
	...
	/**
	 * Restituisce il voto, solo se l'esame è stato superato, altrimenti
	 * eccezione.
	 * 
	 * @return the voto
	 */
	...
	/**
	 * Se l'esame non è ancora superato, lo considera superato con il voto e la
	 * data specificati. Se invece l'esame era già superato, genera
	 * un'eccezione.
	 * 
	 * @param voto
	 * @param data
